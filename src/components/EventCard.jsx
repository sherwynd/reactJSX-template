...
const card = (
    <React.Fragment>
      <CardContent>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
          ...
          <Button onClick={handleViewClick} variant="outlined" size="small">View</Button>
        </Box>
      </CardContent>
    </React.Fragment>
);
  ...
  return (
    <Box sx={{ minWidth: 275}}>
      <Card variant="outlined" sx={{ backgroundColor: '#F2F2F2', borderRadius: 5, boxShadow: 2}}>{card}</Card>
    </Box>
  );
}
