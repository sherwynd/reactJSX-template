import { TextField, Typography, Button, FormControl, InputLabel, InputAdornment, OutlinedInput, Select, MenuItem, Stack, Box, Grid } from '@mui/material';
    ...
    return (
        <>
            ...
            <Stack spacing={2} component="form" onSubmit={handleSubmit} sx={{ justifyContent: "center", alignItems: "center", display: "flex", mb: 5 }}>
                ...
                <Button onSubmit={handleSubmit} variant="contained" color="primary" type="submit" sx={{ m: 1, width: "50%" }}>Submit</Button>
            </Stack >
        </>
